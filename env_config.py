...
MAX_QUEUE_SIZE = os.environ.get('MAX_QUEUE_SIZE', 0)

OSS_BUCKET = os.environ.get('OSS_BUCKET', None)

NO_UPDATE_TIMEOUT_SECONDS = os.environ.get('NO_UPDATE_TIMEOUT_SECONDS', 30)

SERVER_HOST = os.environ.get('SERVER_HOST', '0.0.0.0')

SERVER_LISTEN_PORT = os.environ.get('SERVER_LISTEN_PORT', 5000)
